...
const SecondBox = () => {
  ...
  const handleSocialMediaClick = (socialMedia) => {
    const urls = {
      faInstagram: "https://www.instagram.com/techjobsolution?igsh=ZnlhNXhnMzViazZq",
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_n6sz019', 'template_ctje8qo', templateParams, '-yDXwwX9dj3yVyUwD')
      .then((response) => {
