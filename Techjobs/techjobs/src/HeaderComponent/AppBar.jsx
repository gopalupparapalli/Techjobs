...
const navItems = [
  ...
  { label: "Courses" },
  { label: "Internships", path: "/course/internship" },
  { label: "Contact", path: "/contact" },
];

const courseOptions = [
  { label: "Manual & Automation Testing", path: "/course/testing" },
  { label: "AWS & Devops", path: "/course/aws" },
  { label: "MainFrames", path: "/course/mainframe" },
  { label: "CyberSecurity", path: "/course/cybersecurity" },
  { label: "Python Fullstack", path: "/course/python" },
  { label: "Java Fullstack", path: "/course/java" },
  { label: "DataScience", path: "/course/datascience" },
  { label: "PowerBI", path: "/course/powerBi" },
];
...
function DrawerAppBar(props) {
  ...
  const drawer = (
    <Box sx={{ textAlign: "center" }}>
      ...
      <Divider />
      <Link to="/career">
        <Button type="submit" sx={careersButtonStyle} onClick={() => setMobileOpen(false)}>
          Careers
        </Button>
      </Link>
  ...
  return (
    <Box sx={{ display: "flex" }}>
      <CssBaseline />
      <AppBar component="nav" sx={{ backgroundColor: "white", boxShadow: "none" , height: "0.9in"}}>
        <Toolbar sx={{ py: "30px" }}>
          <IconButton
            color="black"
