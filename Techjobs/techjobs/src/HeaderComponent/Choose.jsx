...
const ChooseUs = () => {
  ...
  const texts = [
    {
      ...
      paragraphs: [
        {
          text: "Tech Jobs Edutech explored all over India to get the best trainers and succeeded with it. We have a pool of trainers working with highly qualified business partners and fortune companies to provide advanced and comprehensive training.",
          style: paraStyle,
        },
        {
    ...
    },
    {
      ...
      paragraphs: [
        {
          text: "At Tech Jobs Edutech, we believe in a practical learning approach. Making students work on real-time data helps in giving them a clear visualization of how it is applied in the real world.",
          style: paraStyle,
        },
        {
    ...
    },
    {
      ...
      paragraphs: [
        {
          text: "We have a collaboration with over 100+ MNCs and SMEs who directly source their business requirements through techjobs. Also having a dedicated placement verticle that enables trainees to take advantage and excel in the career with extensive knowledge gained at Tech Jobs Edutech.",
          style: paraStyle,
        },
        {
  ...
  return (
    <Box
      sx={{
        backgroundColor: "#6a5acd", // Set the background color
        padding: "20px",
      }}
    >
      <Typography
